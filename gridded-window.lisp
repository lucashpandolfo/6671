...
(defclass gridded-window (framework-window)
...
(defmethod initialize-instance :after ((window gridded-window) &key)
...
(defmethod toggle-grid ((w gridded-window))
  (setf (view-grid w) (not (view-grid w))))

(defmethod toggle-axis ((w gridded-window))
  (setf (view-axis w) (not (view-axis w))))

(defmethod toggle-edit-panel ((w gridded-window))
...
(defmethod set-panel-top-env ((w gridded-window))
...
(defmethod init ((w gridded-window))
...
(defmethod glut:display ((w gridded-window))
  (unless (grid-list w)
